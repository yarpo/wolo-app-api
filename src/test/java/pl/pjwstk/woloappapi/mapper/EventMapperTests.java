...
public class EventMapperTests {
    ...
    public void testToShiftResponseDto(){
        ...
        List<ShiftResponseDto> shiftResponseDtoList = eventMapper.toShiftResponseDto(event);

        assertEquals(2, shiftResponseDtoList.size());

        ShiftResponseDto shiftResponseDto1 = shiftResponseDtoList.get(0);
        assertEquals(1L, shiftResponseDto1.getShiftId());
        assertEquals(1L, shiftResponseDto1.getEventId());
        assertEquals("Test Event", shiftResponseDto1.getName());
        assertEquals(LocalTime.of(9, 0), shiftResponseDto1.getStartTime());
        assertEquals(LocalTime.of(17, 0), shiftResponseDto1.getEndTime());
        assertEquals(LocalDate.now(), shiftResponseDto1.getDate());


        ShiftResponseDto shiftResponseDto2 = shiftResponseDtoList.get(1);
        assertEquals(LocalTime.of(10, 0), shiftResponseDto2.getStartTime());
        assertEquals(LocalTime.of(18, 0), shiftResponseDto2.getEndTime());
        assertEquals(LocalDate.now(), shiftResponseDto2.getDate());
