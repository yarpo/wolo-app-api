...
INSERT INTO "user" ( firstname, lastname, email, phone_number, role_id, is_pesel_verified, is_agreement_signed, is_adult, password) VALUES
                                                                                                                                                 ( 'Jan', 'Kowalski', 'jan.kowalski@example.com', '123456789', 3, true, true, true, 'password'),
                                                                                                                                                 ( 'Anna', 'Nowak', 'anna.nowak@example.com', '987654321', 3, false, true, true, 'password'),
                                                                                                                                                 ( 'Piotr', 'Wójcik', 'piotr.wojcik@example.com', '456789123', 2, true, false,false, 'password');
