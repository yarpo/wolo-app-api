...
INSERT INTO organisation ( "name", description, email, phone_num, address_id, is_approved, moderator_id) VALUES
                                                                                                             ( 'Pomorska Fundacja Bracia Mniejsi', 'Pomagamy zwierzakom).', 'info@sprintclub.com', '123456789', 1, true, 1),
...
INSERT INTO event ( "name", description, category_id, is_pesel_ver_req, is_agreement_needed, organisation_id) VALUES
                                                                                                                  ( 'Bieg Maratoński', ' Pieski spędzające cały dzień na kanapie się nudzą
Dlatego poszukujemy wolontariuszy, do spacerów z dużymi psami, które mieszkają w Leźnie i są pod opieką naszej Fundacji.', 1, false, false, 1),
...
O godzinie 10:00 rozpocznie się część oficjalna z przemówieniami.', 3, true, true, 2);
